...
在 `st1page/gh-actions-lab` 公共仓库中，设计并运行 9 个 workflow 覆盖 GitHub Actions 核心场景，目标是产出 `roles/maintainer/skills/github-actions/SKILL.md`。

仓库：https://github.com/st1page/gh-actions-lab
